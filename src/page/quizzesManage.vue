<template>
    <div class="fillcontain">
    	<div class="go-back bt"><el-button type="primary" size="small">题库上传</el-button></div>
        <div class="table_container">
        	<el-button type="primary" size="small">竞答设置</el-button>
            <el-table :data="tableData" style="width: 100%">
                <el-table-column prop="user_name" label="编号">
                </el-table-column>
                <el-table-column prop="create_time" label="题目">
                </el-table-column>
                <el-table-column prop="city" label="选项1">
                </el-table-column>
                <el-table-column prop="admin" label="选项2">
                </el-table-column>
                <el-table-column prop="admin" label="选项3">
                </el-table-column>
                <el-table-column prop="admin" label="正确答案">
                </el-table-column>
            </el-table>
