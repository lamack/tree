    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            <el-table :data="tableData" style="width: 100%">
                <el-table-column prop="user_name" label="序列">
                </el-table-column>
                <el-table-column prop="create_time" label="灾害类型">
                </el-table-column>
                <el-table-column prop="city" label="灾害触发时间">
                </el-table-column>
                <el-table-column prop="admin" label="公告发布时间">
                </el-table-column>
